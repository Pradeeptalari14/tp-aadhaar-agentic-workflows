...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/aadhaar-agentic-workflows/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-aadhaar-agentic-workflows.git
cd tp-aadhaar-agentic-workflows
```
...
```bash
kubectl port-forward deployment/tp-aadhaar-agentic-workflows 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── aadhaar_verification.py     # Main configuration file
```
...
---
*Generated by [Aadhaar-authenticated Agentic Workflow System Studio](https://pradeeptalari14.github.io/portfolio/tools/aadhaar-agentic-workflows/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
